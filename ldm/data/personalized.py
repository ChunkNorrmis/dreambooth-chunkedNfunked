...
class PersonalizedBase(Dataset):
    ...
    def blur(self, img):                                                                                                                                                                                                
        if random.random() < self.odds:
            ...
            img = cv2.GaussianBlur(img, kern, sig)
        return img
